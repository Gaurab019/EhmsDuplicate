...
const LabItemsPanel = () => {
  const [selectedOption, setSelectedOption] = useState("AddLabItems");
      ...
      <div className="flex gap-5">
        <div className="flex flex-col [flex:20]">
          ...
          {/* <button
            className={activeStyle}
            onClick={() => {
              setSelectedOption("SearchLabItems");
            }}
          >
            Search Lab Item
          </button> */}
        ...
        <div className="[flex:80]">
          {selectedOption == "AddLabItems" ? (
            <AddLabItems />
          ) : selectedOption == "SearchLabItems" ? (
            <SearchLabItem />
          ) : (
            <></>
          )}
